...
var (
	...
	GenesisDifficulty      = big.NewInt(131072000) // Difficulty of the Genesis block.
	MinimumDifficulty      = big.NewInt(131072000) // The minimum that the difficulty may ever be.
