...
var (
	...
	GenesisDifficulty      = big.NewInt(1310720000) // Difficulty of the Genesis block.
	MinimumDifficulty      = big.NewInt(1310720000) // The minimum that the difficulty may ever be.
